...
namespace DLMonitor
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public string  Celsius_Mail, Humidit_Mail,Day_Mail,DL_Open, User, Subject, Body, Mail1, Mail2, Mail3, Mail4, Mail5,Re_Conn;
        public int Hour,Time,Time_Out,H_Start, H_End, C_Start, C_End,Mode,R_Start,R_End;
                ...
                if (DL_Open == "OFF")
                {
                    ...
                    if (R_End > 0)
                    {
                        ...
                        if (R_Start >= R_End)
                        {
                            ...
                            thread.Start();
                            R_Start = 0;
                            R_End = int.Parse(NUP_ReConn.Value.ToString()) * 60;
                        }
                    }
                    Mode = 1;
                    Subject = "設備異常";
